...
public class Transaction { // First class
	...
	Transaction(String tx_hash, // Constructor initialization
	String from_addr,
	String to_addr,
	String block_number,
	String token_qty,
	...
	public static void main(String[] args)
	{
		...
		{
		int count =0;
		BufferedReader br = new BufferedReader(new FileReader("/Users/srikaramara/Git/ds/transactions.csv"));
